...
The data used in this document reflects the information stored in the ACE database on the 5th November {{< var doc.year_report_plus1 >}}. @fig-figure-1-2 shows the status of the ACE data validation process for the data presented in this document.

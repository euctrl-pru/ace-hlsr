...
![Timeline to produce the next ACE benchmarking report](figures/Figure-1-1.png){#fig-figure-1-1 width="100%"}
...
Seventeen ANSPs submitted their ACE {{< var doc.year_report >}} data on time by the 1st of July {{< var doc.year_report_plus1 >}} and, all data submissions were received by the end of August {{< var doc.year_report_plus1 >}}. This constitutes a major improvement compared to previous years. Clearly, the timescale to produce the ACE benchmarking report is inevitably delayed if data are not submitted on time.

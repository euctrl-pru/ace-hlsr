...
@fig-figure-5-1 presents the changes in the average current ratio between {{< var doc.year_report_minus5 >}} and {{< var doc.year_report >}} as well as the 1st and 3rd quartiles. The current ratio (current assets divided by current liabilities) measures the ability of a company to pay its short-term debt obligations with its current assets. On average, the situation slightly improved in {{< var doc.year_report >}} following four years of continuous deterioration. However, for 25% of the sample, the current ratio has shown almost no improvement since reaching its lowest level in 2020.
...
In {{< var doc.year_report >}}, the average cash-on-hand days amounted to 177 days, which is +70 days higher than in 2021 and +7 days higher than in 2020. The 2022 figure reached the pre-pandemic levels. More detailed analysis on these financial indicators will be available in the forthcoming ACE report.

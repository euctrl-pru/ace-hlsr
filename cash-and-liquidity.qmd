...
![Changes in ANSPs balance sheet structure (2019-`r year_report`)](figures/Figure-5-bal-str.png){#fig-figure-5-1 width="75%"}


@fig-figure-toto shows capital and reserves increased by +4.2% in `r year_report` but remained - €778M lower than in 2019.
...
![2016-`r year_report` trends in cash-on-hand days at Pan-European system level](figures/Figure-5-cash.png){#fig-figure-5-cash width="50%"}

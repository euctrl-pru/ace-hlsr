...
## Changes in the balance sheet structure {#sec-covid_1}
...
![Changes in ANSPs balance sheet structure (2019-2020)](figures/Figure-5-1.png){#fig-figure-5-1 width="85%}
...
```{r Figure-5-2, out.width='90%',echo=FALSE}
knitr::include_graphics('figures/Figure-5-2.png')
```
:::
:::

## Financial indicators calculated from ANSPs ACE data submissions {#sec-covid_2}
...
```{r figure19-bis, out.width='100%',echo=FALSE}
knitr::include_graphics('figures/Figure-5-3.png')
```

<br><br>

```{r figure20-bis, out.width='100%',echo=FALSE}
knitr::include_graphics('figures/Figure-5-4.png')
```

<br>

```{r fig-figure21-bis, fig.cap = 'Changes in ANSPs balance sheet structure (2019-2020)', out.width='100%',echo=FALSE}
...
## Cash flow indicators calculated from ANSPs financial statements {#sec-covid_3}
...
![2019-2020 trends in free cash flow to revenues ratio at ANSP level](figures/Figure-5-6.png){#fig-figure-5-6 width="100%}

@fig-figure-5-6 shows the 2019-2020 changes in free cash flow to revenues ratio (and its components) at ANSP level for 24 ANSPs for which data is publically available at the time of writing this report[^ansps-cash-and-liquidity-issues-as-a-result-of-the-covid-19-pandemic-4].

[^ansps-cash-and-liquidity-issues-as-a-result-of-the-covid-19-pandemic-4]: @fig-figure-5-6 is sourced from the ANSP Financial Dashboard produced by the EUROCONTROL Aviation Intelligence Unit. All data from this dashboard has been collected from ANSPs' most recent financial statements. For more details, see: <https://ansperformance.eu/economics/finance/>.

Whereas 15 of these ANSPs had a positive ratio in 2019, all ANSPs analysed (with the exception of Albcontrol) have a negative ratio in 2020. Although changes in the free cash flow are mainly driven by changes in the net cash flow from operating activities (see middle chart in @fig-figure-5-6), it is interesting to note that when the free cash flow was negative in 2019, it was in several cases due to relatively large capital expenditures during the year (e.g. in 2019, Sakaeronavigatsia and LGS respectively invested 37% and 29% of their revenues).
...
```{r Figure-5-7, out.width='100%',echo=FALSE}

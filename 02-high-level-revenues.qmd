...
```{r Figure-2-1, fig.cap = '(ref:Figure-2-1)', out.width='100%'}
knitr::include_graphics('figures/Figure-2-1.png')
```
...
```{r Figure-2-3, fig.cap = '(ref:Figure-2-3)', out.width='100%'}
...
```{r Figure-2-5, fig.cap = '(ref:Figure-2-5)', out.width='85%'}
...
```{r Figure-2-6, fig.cap = '(ref:Figure-2-6)', out.width='90%'}
knitr::include_graphics('figures/Figure-2-6.png')
```

(ref:Figure-2-7) Total gate-to-gate ATM/CNS staff per staff category and changes, 2019-2020

```{r Figure-2-7, fig.cap = '(ref:Figure-2-7)', out.width='80%'}
knitr::include_graphics('figures/Figure-2-7.png')
```

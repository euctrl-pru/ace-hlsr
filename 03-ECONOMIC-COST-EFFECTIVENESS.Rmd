...
```{r figure9, echo=FALSE, fig.cap = "Trend of unit economic costs at Pan-European system level, 2014-2019 (real terms)^[Sakaeronavigatsia is excluded from the trend analysis provided in this section since no data is available prior to 2015 for this ANSP.]", out.width='50%', fig.align='center', out.width = '100%'}
knitr::include_graphics('Z:/ACE/2019/HLSR in Bookdown/Figure 3-1-Left.png')
knitr::include_graphics('Z:/ACE/2019/HLSR in Bookdown/Figure 3-1-Right.png')
```

...
```{r Figure-2-1, fig.cap = '(ref:Figure-2-1)', out.width='80%'}
...
```{r Figure-2-3, fig.cap = '(ref:Figure-2-3)', out.width='70%'}
...
```{r Figure-2-5, fig.cap = '(ref:Figure-2-5)', out.width='70%'}
...
```{r Figure-2-6, fig.cap = '(ref:Figure-2-6)', out.width='60%'}
...
```{r Figure-2-7, fig.cap = '(ref:Figure-2-7)', out.width='70%'}

...
This section provides a [preliminary]{.underline} presentation of high-level revenues, costs and staff data provided in ANSPs ACE 2020 data submissions. Total ANS revenues in 2020 amounted to €4 502M. Most en-route revenues come from the collection of en-route charges (91.4%, see left pie chart). The proportion of terminal revenues from charges is lower (50.9%, see right pie chart), as additional income may directly come from airport operators (31.2% e.g. through a contractual arrangement between the ANSP and the airport operator).

![Breakdown of gate-to-gate ANS revenues, 2020](./figures/Figure-2-1.png){#fig-figure-2-1 width="100%"}
...
```{r Figure-2-2, out.width='100%', echo=FALSE}
knitr::include_graphics('figures/Figure-2-2.png')
```
:::
:::
...
![Gate-to-gate ATM/CNS provision costs at Pan-European system level, 2020](./figures/Figure-2-3.png){#fig-figure-2-3 width="100%"}

In 2020, the five largest ANSPs (ENAIRE, ENAV, DFS, DSNA and NATS) bore some 56% of total Pan-European gate-to-gate ATM/CNS provision costs, while the five smallest ANSPs accounted for some 1% (see bottom left part of @fig-figure-2-5).

ATM/CNS provision costs increased by +1.3% p.a. between 2015 and 2019, and then fell by -5.0% in 2020 as ANSPs implemented a range of measures to reduce costs and preserve liquidities. As shown in the bottom right part of @fig-figure-2-5, the -5.0% decrease in ATM/CNS costs in 2020 reflects reductions for 31 out of 38 ANSPs. More details on the changes in ANSPs ATM/CNS provision costs in 2020 will be available in the final ACE 2020 benchmarking report.
...
![Changes in ATM/CNS provision costs, 2015-2020 (real terms)](./figures/Figure-2-5.png){#fig-figure-2-5 width="85%"}
...
![Breakdown of total gate-to-gate ATM/CNS staff at Pan-European system level, 2020](./figures/Figure-2-6.png){#fig-figure-2-6 width="90%"}

![Total gate-to-gate ATM/CNS staff per staff category and changes, 2019-2020](./figures/Figure-2-7.png){#fig-figure-2-7 width="80%"}
...
The trends shown in the @fig-figure-2-7 should therefore be interpreted with caution.

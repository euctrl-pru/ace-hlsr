...
```{r Figure-2-2-cfh, out.width='100%', echo=FALSE}
knitr::include_graphics('figures/Figure-2-2-cfh.png')
```

```{r Figure-2-2-rev, out.width='100%', echo=FALSE}
knitr::include_graphics('figures/Figure-2-2-rev.png')
```
...
In 2021, the five largest ANSPs (ENAIRE, ENAV, DFS, DSNA and NATS) bore some 56% of total Pan-European gate-to-gate ATM/CNS provision costs, while the five smallest ANSPs accounted for some 1% (see bottom left part of @fig-figure-2-5).
...
The trends shown in the @fig-figure-2-6 should therefore be interpreted with caution.

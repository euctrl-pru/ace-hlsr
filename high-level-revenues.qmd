...
::: {#fig-2-2}
![](figures/Figure-2-2-all.png){width=100%} 
...
::: {#fig-figure-2-4}
![](figures/Figure-2-4.png){width=80%}
...
ANSPs’ cash and liquidity situation is outlined in more detail in @sec-covid.

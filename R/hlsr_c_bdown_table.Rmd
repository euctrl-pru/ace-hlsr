...
cost_data  <-  read_xlsx("//sky.corp.eurocontrol.int/DFSRoot/Groups/HQ/dgof-pru/Project/ACE/Data for ACE landing page and digital reports/hlsr2021_data.xlsx",
...
atco_data  <-  read_xlsx("//sky.corp.eurocontrol.int/DFSRoot/Groups/HQ/dgof-pru/Project/ACE/Data for ACE landing page and digital reports/hlsr2021_data.xlsx",
                       sheet = "F_Cost breakdown",
...
table_cost <- reactable(
  ...
  columns = list(
    LABEL = colDef(name="", minWidth = 40, align = "left",style = list(whiteSpace = "pre", "font-size" = "11px")), # to preserve whitespace,
  ...
  columnGroups = list(
    colGroup(name = "", columns = c("LABEL"), headerStyle = list(background = "#538DD5", color = "white", fontSize = "11px")),
    colGroup(name = "En-route", columns = c("ERT_F", "ERT_PERC"), headerStyle = list(background = "#538DD5", color = "white", fontSize = "11px")),
    colGroup(name = "Terminal", columns = c("TRM_F", "TRM_PERC"), headerStyle = list(background = "#538DD5", color = "white", fontSize = "11px")),
    colGroup(name = "Gate-to-gate", columns = c("G2G_F", "G2G_PERC"), headerStyle = list(background = "#538DD5", color = "white", fontSize = "11px"))
  ),
  borderless = TRUE,
  rowStyle = 
    function(index) {

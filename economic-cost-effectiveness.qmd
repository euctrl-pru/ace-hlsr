...
The most common factors in ATFM delays were capacity and staffing, followed by weather. Individual ANSPs were impacted by other factors, such as ATC industrial action (DSNA), implementation of capacity improvement projects (4-Flight for DSNA, iCAS for DFS) and ongoing effects of the war in Ukraine (HungaroControl, DFS) . 

...
[^economic-cost-effectiveness-1]: See [https://ansperformance.eu/economics/ace/ace-handbook/](https://ansperformance.eu/economics/ace/ace-handbook/) for more information on the methodology used to compute composite flight-hours and economic costs.
...
::::: {#fig-figure-3-1-left fig-pos='h'}
![](figures/figure-3-1-1-hlsr_evo_eco_ce.png)

 
:::::

::::: {#fig-figure-3-1-right fig-pos='h'}
...
<!-- to avoid figure in the middle of the page -->
